insert into storefront.store_collection (id, title, featured_product_id)
...
insert into storefront.store_product (id, title, description, unit_price, inventory, last_update, collection_id, slug)
...
insert into storefront.store_customer (id, first_name, last_name, email, phone, birth_date, membership)
...
insert into storefront.store_order (id, placed_at, payment_status, customer_id)
...
insert into storefront.store_orderitem (id, quantity, unit_price, order_id, product_id)
